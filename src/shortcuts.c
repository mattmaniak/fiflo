...
void shortcuts__arrow_left(Buff_t* Buffer, Conf_t* Config, Mod_t* Modes)
{
...
void shortcuts__arrow_right(Buff_t* Buffer, Conf_t* Config, Mod_t* Modes)
{
    if(Modes->live_fname_edit)
    {
...
void shortcuts__arrow_up(Buff_t* Buffer)
{
    if(!CURSOR_AT_TOP)
    {
...
void shortcuts__arrow_down(Buff_t* Buffer)
{
...
void shortcuts__ctrl__arrow_up(Buff_t* Buffer)
{
...
void shortcuts__ctrl__arrow_down(Buff_t* Buffer)
{
